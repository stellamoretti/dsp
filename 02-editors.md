...
>> I am very new to the use of terminal editors, so nano seems to be the simplest to use for now.  But I would like to become familiar with all three editors over time.
